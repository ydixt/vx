...
function (_Component) {
  ...
  _createClass(Text, [{
    ...
    key: "leftShift",
    value: function leftShift(lineWidth, align) {
      var _props = props,
          textWidth = _props.width,
          x = _props.x;
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          textProps = _objectWithoutProperties(_this$props, ["dx", "dy", "textAnchor", "verticalAnchor", "align", "scaleToFit", "angle", "lineHeight", "capHeight", "innerRef"]);
...
Text.propTypes = {
  ...
  align: _propTypes["default"].oneOf(['left', 'middle', 'end', 'right']),
